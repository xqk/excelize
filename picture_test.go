...
func TestAddPicture2(t *testing.T) {
	...
	coverPath := filepath.Join("test", "images", "4108bac67cefca1749741c0d6beb5d1cc722dec6.jpg")
	f.SetRowHeight("sheet1", dataStartIdx, 56)
	if err := f.AddPicture(sheet, fmt.Sprintf("C%d", dataStartIdx), coverPath, &GraphicOptions{
		PrintObject:     &enable,
